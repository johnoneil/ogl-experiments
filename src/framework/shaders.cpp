...
GLuint LoadShaderFromFiles(const char * vertex_file_path,const char * fragment_file_path) {
	...
	return LoadShaderFromSource(VertexShaderCode.c_str(), FragmentShaderCode.c_str());
}
